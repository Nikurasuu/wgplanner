...
func (s *Server) Run() error {
	...
	c := cors.New(cors.Options{
		AllowedOrigins:   []string{"https://wgplanner.niklas-malkusch.de", "https://wgplanner.niklas-malkusch.de/", "http://localhost:5173", "http://localhost:8080"},
	...
	srv := fuego.NewServer(
		...
		fuego.WithAddr(s.cfg.Server.Host+":"+strconv.Itoa(s.cfg.Server.Port)),
	)
